...
export default {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      // Create proxied request. Build headers carefully — don't forward Host or cookies
      ...
      // Diagnostic: record which URL was requested and which URL responded
      ...
      if (contentType.startsWith('text/html') || contentType.includes('xml')) {
        ...
        // Diagnostic headers to help verify where fetch went
